...
namespace MyFaculty2.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,LastName,DateOfBirth,GroupId,StatusId,UserId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,LastName,DateOfBirth,GroupId,StatusId,UserId")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
